...
X_train = X_train[['STR_HDA_HKJC_H', 'STR_HDA_AVG_H',
                   'STR_HDA_AVG_D', 'STR_HDA_AVG_A', 'STR_HDA_HKJC_A']]
X_val = X_val[['STR_HDA_HKJC_H', 'STR_HDA_AVG_H',
               'STR_HDA_AVG_D', 'STR_HDA_AVG_A', 'STR_HDA_HKJC_A']]
X_test = X_test[['STR_HDA_HKJC_H', 'STR_HDA_AVG_H',
                 'STR_HDA_AVG_D', 'STR_HDA_AVG_A', 'STR_HDA_HKJC_A']]
...
sheet = client.open("ML Asian").worksheet("JCTwist")
