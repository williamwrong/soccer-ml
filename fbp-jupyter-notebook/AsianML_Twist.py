...
df1 = df.drop(['MATCH_ID', 'MATCH_DATETIME', 'LEAGUE', 'HOME_TEAM', 'AWAY_TEAM', 'HOME_FT_GOAL', 'AWAY_FT_GOAL',
               'STR_A_HKJC_HDC', 'STR_A_HKJC_H', 'STR_A_HKJC_A', 'STR_A_HKJC_H_DIFF', 'STR_A_HKJC_A_DIFF'], axis=1)
...
X_train = X_train[['STR_HDA_AVG_A', 'STR_HDA_YINGWO_A_DIFF', 'AWAY_AWAY_WIN_RATE', 'STR_HDA_HKJC_D', 'STR_A_MACAU_H_DIFF', 'STR_HDA_BET365_D', 'STR_OU_PINNACLE_HDC', 'STR_HDA_BET365_A_DIFF', 'STR_HDA_HKJC_A_DIFF', 'STR_HDA_YINGWO_H', 'AWAY_WIN_RATE', 'HOME_TOTAL_GF', 'STR_HDA_AVG_H', 'STR_A_PINNACLE_A_DIFF', 'STR_A_PINNACLE_H_DIFF', 'STR_A_BET365_A', 'STR_OU_PINNACLE_LO', 'STR_HDA_MACAU_D_DIFF', 'HOME_TOTAL_GA',
                   'STR_OU_YINGWO_LO', 'HOME_AVG_GF', 'STR_HDA_BET365_D_DIFF', 'HOME_HOME_AVG_GF', 'STR_A_MACAU_H', 'STR_HDA_PINNACLE_A', 'STR_HDA_MACAU_H_DIFF', 'STR_HDA_YINGWO_D_DIFF', 'HOME_HOME_GF', 'AWAY_AWAY_LOSE_RATE', 'STR_OU_MODE_HDC', 'STR_OU_BET365_HDC', 'AWAY_TOTAL_GA', 'STR_OU_BET365_LO', 'STR_OU_HKJC_LO', 'STR_OU_HKJC_HI', 'STR_OU_HKJC_HDC', 'STR_OU_YINGWO_HDC', 'STR_OU_PINNACLE_HI', 'STR_OU_YINGWO_HI']]
X_val = X_val[['STR_HDA_AVG_A', 'STR_HDA_YINGWO_A_DIFF', 'AWAY_AWAY_WIN_RATE', 'STR_HDA_HKJC_D', 'STR_A_MACAU_H_DIFF', 'STR_HDA_BET365_D', 'STR_OU_PINNACLE_HDC', 'STR_HDA_BET365_A_DIFF', 'STR_HDA_HKJC_A_DIFF', 'STR_HDA_YINGWO_H', 'AWAY_WIN_RATE', 'HOME_TOTAL_GF', 'STR_HDA_AVG_H', 'STR_A_PINNACLE_A_DIFF', 'STR_A_PINNACLE_H_DIFF', 'STR_A_BET365_A', 'STR_OU_PINNACLE_LO', 'STR_HDA_MACAU_D_DIFF', 'HOME_TOTAL_GA',
               'STR_OU_YINGWO_LO', 'HOME_AVG_GF', 'STR_HDA_BET365_D_DIFF', 'HOME_HOME_AVG_GF', 'STR_A_MACAU_H', 'STR_HDA_PINNACLE_A', 'STR_HDA_MACAU_H_DIFF', 'STR_HDA_YINGWO_D_DIFF', 'HOME_HOME_GF', 'AWAY_AWAY_LOSE_RATE', 'STR_OU_MODE_HDC', 'STR_OU_BET365_HDC', 'AWAY_TOTAL_GA', 'STR_OU_BET365_LO', 'STR_OU_HKJC_LO', 'STR_OU_HKJC_HI', 'STR_OU_HKJC_HDC', 'STR_OU_YINGWO_HDC', 'STR_OU_PINNACLE_HI', 'STR_OU_YINGWO_HI']]
X_test = X_test[['STR_HDA_AVG_A', 'STR_HDA_YINGWO_A_DIFF', 'AWAY_AWAY_WIN_RATE', 'STR_HDA_HKJC_D', 'STR_A_MACAU_H_DIFF', 'STR_HDA_BET365_D', 'STR_OU_PINNACLE_HDC', 'STR_HDA_BET365_A_DIFF', 'STR_HDA_HKJC_A_DIFF', 'STR_HDA_YINGWO_H', 'AWAY_WIN_RATE', 'HOME_TOTAL_GF', 'STR_HDA_AVG_H', 'STR_A_PINNACLE_A_DIFF', 'STR_A_PINNACLE_H_DIFF', 'STR_A_BET365_A', 'STR_OU_PINNACLE_LO', 'STR_HDA_MACAU_D_DIFF', 'HOME_TOTAL_GA',
                 'STR_OU_YINGWO_LO', 'HOME_AVG_GF', 'STR_HDA_BET365_D_DIFF', 'HOME_HOME_AVG_GF', 'STR_A_MACAU_H', 'STR_HDA_PINNACLE_A', 'STR_HDA_MACAU_H_DIFF', 'STR_HDA_YINGWO_D_DIFF', 'HOME_HOME_GF', 'AWAY_AWAY_LOSE_RATE', 'STR_OU_MODE_HDC', 'STR_OU_BET365_HDC', 'AWAY_TOTAL_GA', 'STR_OU_BET365_LO', 'STR_OU_HKJC_LO', 'STR_OU_HKJC_HI', 'STR_OU_HKJC_HDC', 'STR_OU_YINGWO_HDC', 'STR_OU_PINNACLE_HI', 'STR_OU_YINGWO_HI']]
...
sheet = client.open("ML Asian").worksheet("Twist")
