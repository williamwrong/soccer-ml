...
# X_train = X_train[['STR_OU_MACAU_LO_DIFF', 'STR_OU_YINGWO_HI_DIFF', 'STR_OU_BET365_HI_DIFF', 'STR_OU_PINGBOK_LO_DIFF', 'STR_OU_PINGBOK_HI_DIFF', 'STR_OU_YINGWO_LO_DIFF',
#                    'STR_OU_BET365_LO_DIFF', 'STR_OU_MACAU_HI_DIFF', 'STR_OU_HKJC_LO_DIFF', 'STR_OU_HKJC_HI_DIFF', 'STR_PINNACLE_D', 'STR_OU_AVG_LO', 'STR_OU_AVG_HI']]
# X_val = X_val[['STR_OU_MACAU_LO_DIFF', 'STR_OU_YINGWO_HI_DIFF', 'STR_OU_BET365_HI_DIFF', 'STR_OU_PINGBOK_LO_DIFF', 'STR_OU_PINGBOK_HI_DIFF', 'STR_OU_YINGWO_LO_DIFF',
#                'STR_OU_BET365_LO_DIFF', 'STR_OU_MACAU_HI_DIFF', 'STR_OU_HKJC_LO_DIFF', 'STR_OU_HKJC_HI_DIFF', 'STR_PINNACLE_D', 'STR_OU_AVG_LO', 'STR_OU_AVG_HI']]
# X_test = X_test[['STR_OU_MACAU_LO_DIFF', 'STR_OU_YINGWO_HI_DIFF', 'STR_OU_BET365_HI_DIFF', 'STR_OU_PINGBOK_LO_DIFF', 'STR_OU_PINGBOK_HI_DIFF', 'STR_OU_YINGWO_LO_DIFF',
#                  'STR_OU_BET365_LO_DIFF', 'STR_OU_MACAU_HI_DIFF', 'STR_OU_HKJC_LO_DIFF', 'STR_OU_HKJC_HI_DIFF', 'STR_PINNACLE_D', 'STR_OU_AVG_LO', 'STR_OU_AVG_HI']]

X_train = X_train[['STR_OU_MACAU_HDC', 'HOME_ADV', 'STR_HKJC_D',
                   'STR_PINNACLE_H', 'STR_YINGWO_D', 'AWAY_TOTAL_GF']]
X_val = X_val[['STR_OU_MACAU_HDC', 'HOME_ADV', 'STR_HKJC_D',
               'STR_PINNACLE_H', 'STR_YINGWO_D', 'AWAY_TOTAL_GF']]
X_test = X_test[['STR_OU_MACAU_HDC', 'HOME_ADV', 'STR_HKJC_D',
                 'STR_PINNACLE_H', 'STR_YINGWO_D', 'AWAY_TOTAL_GF']]
...
# Prediction
col_ml_type = '253'
predict_result = test_result.query(
    'MATCH_DATETIME>\'%s\'' % current_match_date)
