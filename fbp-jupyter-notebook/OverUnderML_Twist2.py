...
try:
    ...
    sql = """
        ...
        WHERE
            ...
            AND hilo.STR_O_HKJC_HI<hilo.STR_O_AVG_HI AND hilo.STR_O_HKJC_LO>hilo.STR_O_AVG_LO
...
X_train = X_train[['AWAY_TOTAL_GA', 'STR_OU_MACAU_LO_DIFF', 'STR_OU_BET365_HI', 'STR_OU_PINGBOK_LO', 'STR_OU_HKJC_HDC', 'STR_OU_MODE_HDC', 'STR_OU_MEDIAN_HI', 'STR_OU_BET365_LO_DIFF', 'STR_OU_PINGBOK_HDC', 'STR_PINNACLE_D',
                   'STR_BET365_D', 'STR_OU_PINGBOK_HI', 'STR_OU_PINGBOK_HI_DIFF', 'STR_OU_BET365_LO', 'AWAY_TOTAL_GF', 'STR_OU_AVG_HI', 'STR_OU_MACAU_HI', 'STR_OU_BET365_HDC', 'HOME_HOME_AVG_GF', 'STR_OU_YINGWO_LO', 'STR_OU_MACAU_LO', 'AWAY_AVG_GF']]
X_val = X_val[['AWAY_TOTAL_GA', 'STR_OU_MACAU_LO_DIFF', 'STR_OU_BET365_HI', 'STR_OU_PINGBOK_LO', 'STR_OU_HKJC_HDC', 'STR_OU_MODE_HDC', 'STR_OU_MEDIAN_HI', 'STR_OU_BET365_LO_DIFF', 'STR_OU_PINGBOK_HDC', 'STR_PINNACLE_D',
               'STR_BET365_D', 'STR_OU_PINGBOK_HI', 'STR_OU_PINGBOK_HI_DIFF', 'STR_OU_BET365_LO', 'AWAY_TOTAL_GF', 'STR_OU_AVG_HI', 'STR_OU_MACAU_HI', 'STR_OU_BET365_HDC', 'HOME_HOME_AVG_GF', 'STR_OU_YINGWO_LO', 'STR_OU_MACAU_LO', 'AWAY_AVG_GF']]
X_test = X_test[['AWAY_TOTAL_GA', 'STR_OU_MACAU_LO_DIFF', 'STR_OU_BET365_HI', 'STR_OU_PINGBOK_LO', 'STR_OU_HKJC_HDC', 'STR_OU_MODE_HDC', 'STR_OU_MEDIAN_HI', 'STR_OU_BET365_LO_DIFF', 'STR_OU_PINGBOK_HDC', 'STR_PINNACLE_D',
                 'STR_BET365_D', 'STR_OU_PINGBOK_HI', 'STR_OU_PINGBOK_HI_DIFF', 'STR_OU_BET365_LO', 'AWAY_TOTAL_GF', 'STR_OU_AVG_HI', 'STR_OU_MACAU_HI', 'STR_OU_BET365_HDC', 'HOME_HOME_AVG_GF', 'STR_OU_YINGWO_LO', 'STR_OU_MACAU_LO', 'AWAY_AVG_GF']]
...
sheet = client.open("ML OverUnder").worksheet("Twist2")
